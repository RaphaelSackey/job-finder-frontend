export default function Card(){
    return (
      <div className="card h-[21.5rem] max-h-[21.5rem] w-[17.2rem] max-w-[17.2rem] rounded-2xl bg-white p-2 mb-4">
        ...
        <div className="card-bottom flex h-[20%] flex-col justify-center px-2">
          <h1 className="">$24/hr</h1>
          <h5 className="text-customRenchGray text-xs">New York, NY</h5>
        </div>
      </div>
    );
}